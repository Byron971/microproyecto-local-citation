"""Reordenador lineal: segunda etapa que reordena los candidatos recuperados."""
...
class LinearReranker:
    ...
    def coefficients(self) -> np.ndarray:
        """Coeficientes aprendidos, en el orden de las características."""
        return self.pipeline.named_steps["classifier"].coef_[0]

    @property
    def intercept(self) -> float:
        """Intercepto aprendido."""
