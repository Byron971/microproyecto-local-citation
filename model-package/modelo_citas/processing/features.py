"""Características numéricas de cada par contexto-artículo."""
...
from modelo_citas.models.tfidf_baseline import build_paper_text, clean_context_text
...
class PairFeatureExtractor:
    ...
    def transform(
        ...
        Los vectores están normalizados en L2, así que la suma del producto
        elemento a elemento es la similitud coseno.
        """
        ...
        missing_papers = [
            pair["paper_id"] for pair in pairs if pair["paper_id"] not in self._paper_row
        ]
        if missing_papers:
