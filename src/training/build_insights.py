...
bigramas en los 63.768 contextos. Por eso el resultado se guarda en disco y
``src.app.insights.load_insights`` solo lo lee; recalcularlo es responsabilidad
de este módulo, del lado de investigación.

Uso:
    python -m src.training.build_insights
    python -m src.training.build_insights --force
"""
