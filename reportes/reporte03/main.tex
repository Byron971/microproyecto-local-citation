...
\texttt{docs/evaluacion\_comparativa\_provisional\_20sep.md}. El conjunto
sigue siendo provisional: falta una segunda validación humana independiente,
cálculo de acuerdo y reconciliación antes de denominarlo \emph{Test Gold}
definitivo.
...
extensión de clasificación de función de cita todavía se requiere una segunda
validación humana independiente, cálculo de acuerdo, reconciliación y repetición
de la evaluación sobre un Test Gold definitivo antes de presentar esos
resultados como definitivos. En el recomendador principal, el Recall@100 de
