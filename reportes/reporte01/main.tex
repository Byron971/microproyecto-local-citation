...
Para cada contexto de entrada, el sistema devolverá una lista ordenada de artículos con un puntaje de relevancia. La Tabla~\ref{tab:ranking} presenta un ejemplo conceptual de la salida.
...
% ======================= 4. REPOSITORIO GIT =======================
\section{Repositorio Git en uso para el código}
