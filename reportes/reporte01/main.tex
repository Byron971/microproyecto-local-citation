...
Carlos Caicedo & Recuperación de las secciones de arquitectura conceptual y resultado esperado, corrección de figuras y soportes, y estructuración del plan de trabajo de las Entregas 2 y 3 en el repositorio. \\
\bottomrule
\end{tabular}
\end{table}
