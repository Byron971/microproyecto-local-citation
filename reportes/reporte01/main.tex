...
El equipo distribuyó el avance entre la definición del producto, la documentación, la infraestructura reproducible y la exploración. La Tabla~\ref{tab:equipo} resume el aporte de cada integrante, respaldado por sus propios commits en el historial de Git, tal como exige la guía del curso.

\begin{table}[h!]
\centering
\caption{Aportes observables en el repositorio}
\label{tab:equipo}
\small
...
\midrule
John Arias & Configuración inicial de DVC y estructura base; versionamiento del dataset; remoto AWS S3; notebook inicial de EDA; análisis de relaciones del dataset e integración de contribuciones mediante Pull Request. \\
Carlos Duque & Documentación y actualización del archivo \texttt{README.md}, generación de archivos de reproducibilidad y maqueta.\\
Jose Zambrana & Configuración remoto DVC, ampliación del notebook EDA, gráficas/evidencias, dependencias, reorganización del reporte según rúbrica \\
Carlos Caicedo & Mejoras del informe, evidencias DVC/S3, corrección de maqueta, ajuste de arquitectura y resultado esperado \\
\bottomrule
\end{tabular}
\end{table}

El historial del repositorio evidencia contribuciones de los cuatro integrantes. Adicionalmente, durante la validación final se comprobó la reproducibilidad del proyecto mediante la creación de en entorno limpio, recuperación de los datos versionados desde Amazon S3 mediante DVC y ejecución completa del notebook de exploración sin errores. 
