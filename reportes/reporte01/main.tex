...
% ======================= TRABAJO EN EQUIPO =======================
% Va dentro de este mismo reporte, pero en su propia hoja.
...
Carlos Duque & Actualización de la documentación del proyecto mediante el \texttt{README} e incorporación de archivos asociados a la definición y reproducibilidad del entorno, incluyendo \texttt{.python-version}, \texttt{pyproject.toml} y \texttt{uv.lock}, además de la maqueta del prototipo. \\
\bottomrule
\end{tabular}
\end{table}
