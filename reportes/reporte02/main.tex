...
% TODO: si cierra el issue #6 antes de la entrega, reemplazar la nota de
% "sin commits" por la descripcion del aporte efectivamente registrado.
José Zambrana &
Responsable del entrenamiento y la evaluación del modelo supervisado de relevancia sobre los pares generados (\textit{issue} \#6). En la Entrega 1 aportó la exploración de datos y su cuaderno. \emph{Sin \textit{commits} registrados en la ventana de esta entrega; su último aporte es del 22 de agosto de 2026.} \\[3pt]
